...
#define FT8_VSIZE     (VSIZE)  /* Tvd Number of visible lines (in lines) - display height */                   //CHANGE THIS IF NEEDED (DIFFERENT SCREEN) (user input file)
...
#define FT8_HSIZE     (HSIZE)  /* Thd Length of visible part of line (in PCLKs) - display width */             //CHANGE THIS IF NEEDED (DIFFERENT SCREEN) (user input file)
